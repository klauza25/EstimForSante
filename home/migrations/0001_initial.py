# Generated by Django 5.1.6 on 2025-07-18 13:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consultation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='examens', to='home.consultation')),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home.patient', verbose_name='Patient')),
            ],
            options={
                'verbose_name': 'Examen',
