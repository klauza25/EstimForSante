# Generated by Django 5.1.6 on 2025-07-18 15:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_examen', models.DateField(auto_now_add=True, verbose_name='Date de l’examen')),
                ('resultat', models.TextField(blank=True, null=True, verbose_name='Résultat')),
                ('cout', models.DecimalField(blank=True, decimal_places=2, default=Decimal('0.00'), max_digits=10, verbose_name='Coût de l’examen')),
                ('statut', models.CharField(choices=[('En attente', 'En attente'), ('Réalisé', 'Réalisé')], default='En attente', max_length=15, verbose_name='Statut')),
                ('consultation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home.consultation', verbose_name='Consultation')),
            ],
            options={
                'verbose_name': 'Examen',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('montant_total', models.DecimalField(decimal_places=2, default=Decimal('0.00'), max_digits=12, verbose_name='Montant total dû')),
                ('montant_paye', models.DecimalField(decimal_places=2, default=Decimal('0.00'), max_digits=12, verbose_name='Montant payé')),
                ('difference_rendue', models.DecimalField(decimal_places=2, default=Decimal('0.00'), max_digits=12, verbose_name='Différence rendue')),
                ...
                ('personnel', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='home.personnel', verbose_name='Utilisateur qui a enregistré le paiement')),
            ],
            options={
